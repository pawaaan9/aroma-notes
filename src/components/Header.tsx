        ...
        <div className="absolute inset-0 overflow-hidden">
         ...
         <div className="container mx-auto flex items-center justify-between px-4 py-4 sm:px-6 lg:px-[5vw] relative z-10">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            <Link className="text-sm font-medium font-saira uppercase text-gray-800 hover:text-primary transition-all duration-300 relative group px-3 py-2 rounded-lg" href="/">
            ...
            <Link className="text-sm font-medium font-saira uppercase text-gray-800 hover:text-primary transition-all duration-300 relative group px-3 py-2 rounded-lg" href="/products">
              <span className="relative z-10 transition-all duration-300 group-hover:scale-105">Products</span>
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-primary to-orange-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center"></div>
            </Link>
            <Link className="text-sm font-medium font-saira uppercase text-gray-800 hover:text-primary transition-all duration-300 relative group px-3 py-2 rounded-lg" href="/about">
