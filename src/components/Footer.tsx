      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 md:justify-start">
            <a className="text-sm text-gray-400 hover:text-primary transition-all duration-300 relative group" href="#">
          ...
          <div className="flex justify-center gap-4">
            <a className="text-gray-400 hover:text-primary transition-all duration-300 hover:scale-110" href="#">
        ...
        <div className="text-center">
          <p className="mt-6 text-sm text-gray-500">© 2025 Aroma Essence. All rights reserved.</p>
